...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <motion.section 
        ref={targetRef}
        className="relative pt-24 pb-16 md:pt-32 md:pb-24 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 overflow-hidden"
      >
        {/* 배경 원소들 */}
        <motion.div 
          initial={{ opacity: 0 }}
        ...
        >
          <div className="absolute top-20 right-20 w-64 h-64 rounded-full bg-indigo-300/20 blur-3xl"></div>
          <div className="absolute -bottom-10 -left-10 w-80 h-80 rounded-full bg-purple-300/20 blur-3xl"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full bg-pink-300/10 blur-3xl"></div>
          <div className="absolute top-1/3 right-1/3 w-40 h-40 rounded-full bg-blue-300/10 blur-3xl"></div>
          ...
          <motion.div 
            ...
            className="absolute top-[20%] right-[30%] w-4 h-4 rounded-full bg-indigo-400/30"
          ></motion.div>
          <motion.div 
            animate={{ 
              y: [0, 30, 0],
            ...
            className="absolute bottom-[30%] left-[25%] w-6 h-6 rounded-full bg-purple-400/30"
          ></motion.div>
          <motion.div 
            animate={{ 
              y: [0, -15, 0],
            ...
            className="absolute top-[35%] left-[15%] w-5 h-5 rounded-full bg-pink-400/30"
          ></motion.div>
        </motion.div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 md:gap-16">
            <div className="text-left max-w-xl">
              <motion.div 
                ...
                transition={{ duration: 0.5 }}
                className="inline-block py-1 px-3 rounded-full bg-indigo-100 text-indigo-800 text-sm font-medium mb-5"
              >
                뽀모도로 + 사이트 차단 = 집중력 향상
              </motion.div>
              ...
              <motion.p 
                ...
                className="text-xl text-gray-700 mb-8 md:pr-8"
              >
              ...
              >
                ...
                >
                  <a 
                    ...
                    className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold rounded-xl shadow-lg hover:shadow-indigo-500/25 transition-all flex items-center"
                  >
                ...
                <Link href="/contact" className="px-6 py-4 bg-white text-indigo-600 font-medium rounded-xl border border-indigo-200 hover:bg-indigo-50 transition-colors flex items-center">
              ...
              >
                <span className="text-gray-600 text-sm">✓ 개인정보 수집 없음</span>
                <span className="text-gray-600 text-sm">✓ 광고 없음</span>
                <span className="text-gray-600 text-sm">✓ 설치 10초</span>
              </motion.div>
            </div>
            ...
            <motion.div 
              ...
              transition={{ duration: 0.8, delay: 0.3 }}
              className="relative flex-shrink-0 max-w-sm"
            >
              ...
              <div className="bg-white p-3 rounded-3xl shadow-2xl relative z-10">
                <div className="bg-gray-100 rounded-2xl p-4 relative overflow-hidden">
                  ...
                  <div className="text-center py-8 px-4">
                    <div className="text-5xl font-bold mb-4 text-indigo-600">25:00</div>
                    <div className="bg-indigo-100 rounded-full h-3 mb-6 overflow-hidden">
                      <div className="bg-indigo-600 h-full w-1/3 rounded-full"></div>
                    </div>
                    <div className="flex justify-center gap-4">
                      <button className="bg-indigo-600 text-white px-6 py-2 rounded-lg font-medium">시작</button>
                      <button className="bg-gray-200 text-gray-700 px-6 py-2 rounded-lg font-medium">초기화</button>
                    </div>
                  </div>
                  
                  <div className="mt-6 border-t border-gray-200 pt-4">
                    <div className="text-center text-sm text-gray-500">오늘의 집중시간: 2시간 45분</div>
                    <div className="mt-4 grid grid-cols-7 gap-1">
                      {[...Array(7)].map((_, i) => (
                        <div key={i} className="h-8 bg-indigo-100 rounded-sm relative overflow-hidden">
                          <div 
      ...
      <section className="py-14 bg-gradient-to-br from-indigo-50 via-gray-50 to-blue-50">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <span className="inline-block bg-blue-100 text-blue-800 text-sm font-semibold px-4 py-1.5 rounded-full mb-3">모두를 위한 솔루션</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600 to-indigo-600 opacity-90 transition-opacity z-10 flex items-center justify-center p-6 scale-y-0 group-hover:scale-y-100 origin-bottom transition-transform duration-300">
                <p className="text-white text-sm">
                  시험 준비, 숙제 완성, 공부 시간에 유튜브와 SNS에 빠지지 않도록 도와드립니다. 하루 공부량을 측정하며 동기부여를 받으세요.
                </p>
              </div>
              <div className="h-40 bg-gradient-to-r from-blue-400 to-indigo-400 flex items-center justify-center">
            ...
            <motion.div 
              ...
              className="bg-white rounded-2xl overflow-hidden shadow-lg relative group"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-600 to-purple-600 opacity-90 transition-opacity z-10 flex items-center justify-center p-6 scale-y-0 group-hover:scale-y-100 origin-bottom transition-transform duration-300">
                <p className="text-white text-sm">
                  업무 중 SNS나 뉴스 사이트에 시간을 낭비하지 않도록 합니다. 뽀모도로 타이머로 효율적인 업무 사이클을 만들어 생산성을 높여보세요.
                </p>
              </div>
              <div className="h-40 bg-gradient-to-r from-indigo-400 to-purple-400 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-16 h-16 text-white">
            ...
            <motion.div 
              ...
              className="bg-white rounded-2xl overflow-hidden shadow-lg relative group"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-purple-600 to-pink-600 opacity-90 transition-opacity z-10 flex items-center justify-center p-6 scale-y-0 group-hover:scale-y-100 origin-bottom transition-transform duration-300">
                <p className="text-white text-sm">
      ...
      {/* Benefits Section */}
      <section className="py-14 bg-gradient-to-br from-indigo-50 via-white to-purple-50">
        <div className="container mx-auto px-4 md:px-6">
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="text-center max-w-3xl mx-auto mb-10"
          >
            <span className="inline-block bg-indigo-100 text-indigo-800 text-sm font-semibold px-4 py-1.5 rounded-full mb-3">집중ON 만의 특별함</span>
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
            ...
            {[
              {
                title: '광고 없음',
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 mb-4 mx-auto text-rose-500">
              ...
              },
              {
                title: '개인정보 수집 없음',
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 mb-4 mx-auto text-green-500">
              ...
              },
              {
                title: '완전 무료',
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 mb-4 mx-auto text-amber-500">
              ...
              },
              {
                title: '귀여운 UI',
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 mb-4 mx-auto text-purple-500">
              ...
              },
              {
                title: '설치 10초',
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 mb-4 mx-auto text-blue-500">
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                className="relative overflow-hidden bg-white rounded-xl p-4 md:p-5 text-center shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 group"
              >
                ...
                <div className="absolute -bottom-10 -right-10 w-24 h-24 bg-gradient-to-br from-indigo-100 to-white rounded-full opacity-30 group-hover:opacity-70 transition-opacity"></div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* FAQ Section */}
      <section className="py-14 bg-gradient-to-br from-gray-50 via-white to-indigo-50">
        <div className="container mx-auto px-4 md:px-6">
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="text-center max-w-3xl mx-auto mb-10"
          >
            <span className="inline-block bg-indigo-100 text-indigo-800 text-sm font-semibold px-4 py-1.5 rounded-full mb-3">자주 묻는 질문</span>
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <div className="p-6 border-l-4 border-indigo-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-center">
                  <span className="flex-shrink-0 w-7 h-7 bg-indigo-100 text-indigo-600 rounded-full flex items-center justify-center mr-3 text-sm">Q</span>
                  정말 무료인가요?
                </h3>
                <div className="pl-10">
                  <p className="text-gray-700 text-sm">네, 집중ON은 완전 무료로 제공됩니다. 별도의 구독료나 추가 비용이 전혀 없습니다.</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="p-6 border-l-4 border-purple-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-center">
                  <span className="flex-shrink-0 w-7 h-7 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center mr-3 text-sm">Q</span>
                  개인정보 수집하나요?
                </h3>
                <div className="pl-10">
                  <p className="text-gray-700 text-sm">아니요, 집중ON은 어떠한 개인정보도 수집하지 않습니다. 모든 데이터는 사용자의 브라우저 내에만 저장됩니다.</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="p-6 border-l-4 border-blue-500">
                <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-center">
                  <span className="flex-shrink-0 w-7 h-7 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center mr-3 text-sm">Q</span>
                  어떤 사이트가 차단되나요?
                </h3>
                <div className="pl-10">
                  <p className="text-gray-700 text-sm">기본적으로 유튜브, 인스타그램, 넷플릭스 등 집중을 방해하는 주요 소셜 미디어와 스트리밍 사이트들이 차단됩니다. 사용자가 원하는 사이트를 추가할 수도 있습니다.</p>
                </div>
              </div>
            </motion.div>
      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-0 right-0 w-80 h-80 bg-white rounded-full blur-3xl transform translate-x-1/4 translate-y-1/4"></div>
          <div className="absolute top-1/2 left-1/2 w-60 h-60 bg-pink-200 rounded-full blur-3xl transform -translate-x-1/2 -translate-y-1/2"></div>
        </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              >
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center px-8 py-4 bg-white text-indigo-600 font-bold rounded-xl hover:bg-gray-100 shadow-lg hover:shadow-xl transition-all text-lg"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 mr-2">
                    <path fillRule="evenodd" d="M12 1.5a5.25 5.25 0 00-5.25 5.25v3a3 3 0 00-3 3v6.75a3 3 0 003 3h10.5a3 3 0 003-3v-6.75a3 3 0 00-3-3v-3c0-2.9-2.35-5.25-5.25-5.25zm3.75 8.25v-3a3.75 3.75 0 10-7.5 0v3h7.5z" clipRule="evenodd" />
                  </svg>
              ...
              <Link 
                href="#features" 
                className="inline-flex items-center justify-center px-6 py-4 text-white font-medium border border-white/30 rounded-xl hover:bg-white/10 transition-colors"
              >
                더 알아보기
              </Link>
            </div>
